 ...
 * Prototypes
 */
fjc_clist_t    (fjc_clist_init)     __P ((fjc_deallocator_t *));
void           (fjc_clist_destroy)  __P ((fjc_clist_t));
fjc_error_t    (fjc_clist_del)      __P ((fjc_clist_t, void **, fjc_position_t));
fjc_error_t    (fjc_clist_get)      __P ((fjc_clist_t, void **, fjc_position_t));
...
size_t         (fjc_clist_get_size) __P ((fjc_clist_t));
fjc_position_t (fjc_clist_get_pos)  __P ((fjc_clist_t));
